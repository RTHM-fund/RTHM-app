...
export default function MainArea({ activePage, selectedTemplate, prefillData, selectedDeal, selectedDealIndex, onClearTemplate, onGoBack, onSaveComplete, onNavigateToRAS, onNavigateToRPA, onNavigateToOfferLetter, onOpenValuation, onOpenAgreements, onBackToDeals, valuationState, onUpdateValuationState, arcadeMode, onToggleArcade, runningSkills, setRunningSkills, dataFolders, setDataFolders, valuateFolder, onOpenValuate, drillContainer, setDrillContainer }) {
  ...
  if (activePage === 'dataManager') return wrap(<DataManagerPage runningSkills={runningSkills} setRunningSkills={setRunningSkills} folders={dataFolders} setFolders={setDataFolders} onOpenValuate={onOpenValuate} drillContainer={drillContainer} setDrillContainer={setDrillContainer} />)
  ...
  if (activePage === 'deals') return wrap(<DealsPage onOpenValuation={onOpenValuation} onOpenAgreements={onOpenAgreements} />)
